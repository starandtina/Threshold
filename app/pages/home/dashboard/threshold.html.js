...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (id, thresholds, at, util, operator, warning, error, critical) {
buf.push("<form" + (jade.attr("id", "form-" + (id) + "", true, false)) + " class=\"row clearfix\"><div class=\"cell col-sm-2\"><select id=\"at\" name=\"at\" class=\"form-control\">");
...
buf.push("</select></div><div class=\"cell col-sm-2\"><select id=\"util\" name=\"util\" class=\"form-control\">");
// iterate thresholds.timeRange
;(function(){
  var $$obj = thresholds.timeRange;
  if ('number' == typeof $$obj.length) {
