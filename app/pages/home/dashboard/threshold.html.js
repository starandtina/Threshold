...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (id, at, thresholds, until, operator, warning, error, critical) {
buf.push("<form" + (jade.attr("id", "form-" + (id) + "", true, false)) + " class=\"row threshold-form clearfix\">");
if ( at === 'all day')
{
buf.push("<div class=\"cell col-sm-4\"><select id=\"at\" name=\"at\" class=\"form-control\">");
...
{
buf.push("<div class=\"cell col-sm-2\"><select id=\"at\" name=\"at\" class=\"form-control\">");
// iterate thresholds.timeRange
;(function(){
  var $$obj = thresholds.timeRange;
  if ('number' == typeof $$obj.length) {
...
buf.push("<div class=\"cell col-sm-4\"><div class=\"row\"><div class=\"col-sm-6\"><span class=\"operator-text\">when the <b>ErrorSystem</b></span></div><div class=\"col-sm-6 pl0\"><select id=\"operator\" name=\"operator\" class=\"form-control\">");
