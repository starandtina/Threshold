...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (thresholds, at, util, operator) {
buf.push("<div class=\"container\"><div class=\"tmpst-full-canvas\"><div><h3 data-section=\"create\" class=\"label\">CREATE THRESHOLD</h3><form id=\"threshold-form\" role=\"form\" class=\"form-horizontal\"><fieldset><div class=\"form-group\"><label for=\"at\" class=\"col-sm-2 control-label\">AT</label><div class=\"col-sm-4\"><select name=\"at\" id=\"at\" class=\"form-control time\">");
...
buf.push("</select></div></div><div class=\"form-group\"><label for=\"util\" class=\"col-sm-2 control-label\">UTIL</label><div class=\"col-sm-4\"><select name=\"util\" id=\"util\" class=\"form-control time\">");
// iterate thresholds.timeRange
;(function(){
  var $$obj = thresholds.timeRange;
  if ('number' == typeof $$obj.length) {
...
if ( index % 2 == 0)
{
buf.push("<div class=\"col-md-1\"><span class=\"time\">" + (jade.escape(null == (jade_interp = t) ? "" : jade_interp)) + "</span></div>");
}
    }
...
buf.push("</div><div class=\"bg-gray\"></div></div></div></div><div data-readme=\"privacy-update\" data-readme-show-count=\"10\" data-readme-show-until-closed=\"data-readme-show-until-closed\" data-readme-expires=\"June 1, 2014\" style=\"visibility: visible; display: none;\"><div><span>已经更新了其隐私政策。了解更多</span><a href=\"about\" data-readme-close=\"data-readme-close\" class=\"internal-home\">点击这里查看</a></div><div data-readme-close=\"data-readme-close\" class=\"readme-close-icon\"><i class=\"fa fa-times\"></i></div></div>");}("thresholds" in locals_for_with?locals_for_with.thresholds:typeof thresholds!=="undefined"?thresholds:undefined,"at" in locals_for_with?locals_for_with.at:typeof at!=="undefined"?at:undefined,"util" in locals_for_with?locals_for_with.util:typeof util!=="undefined"?util:undefined,"operator" in locals_for_with?locals_for_with.operator:typeof operator!=="undefined"?operator:undefined));;return buf.join("");
}
